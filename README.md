...
* If you set up an RDS database, your `POSTGRES_HOST` is most likely in the following format: `***.****.us-east-1.rds.amazonaws.com`. You can find this value in the AWS console's RDS dashboard.
